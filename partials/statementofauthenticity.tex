...
Signature:  \\
\IfFileExists{authicenty_signature.png}{%
  \hspace{2cm}%
  \includegraphics[width=.4\linewidth]{authicenty_signature.png}%
}{\fbox{\begin{minipage}{.6\linewidth}\sloppypar
      If you add a file called \texttt{authicenty\_signature.png} to root
